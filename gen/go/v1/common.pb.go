...
type LiveSegmentRef struct {
	...
	SegmentIndex    uint64                 `protobuf:"varint,1,opt,name=segment_index,json=segmentIndex,proto3" json:"segment_index,omitempty"`
...
func (x *LiveSegmentRef) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LiveSegmentRef) ProtoMessage() {}

func (x *LiveSegmentRef) ProtoReflect() protoreflect.Message {
	mi := &file_v1_common_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use LiveSegmentRef.ProtoReflect.Descriptor instead.
func (*LiveSegmentRef) Descriptor() ([]byte, []int) {
	return file_v1_common_proto_rawDescGZIP(), []int{0}
}

func (x *LiveSegmentRef) GetSegmentIndex() uint64 {
	if x != nil {
...
func (x *LiveSegmentRef) GetSeedHash() string {
	if x != nil {
		return x.SeedHash
	}
	return ""
...
func (x *LiveSegmentRef) GetPublishedAtUnix() int64 {
	if x != nil {
...
const file_v1_common_proto_rawDesc = "" +
	"\n" +
	"\x0fv1/common.proto\x12\bbitfs.v1\"~\n" +
	"\x0eLiveSegmentRef\x12#\n" +
	"\rsegment_index\x18\x01 \x01(\x04R\fsegmentIndex\x12\x1b\n" +
	"\tseed_hash\x18\x02 \x01(\tR\bseedHash\x12*\n" +
	"\x11published_at_unix\x18\x03 \x01(\x03R\x0fpublishedAtUnixB2Z0github.com/bsv8/bitfs-contract/gen/go/v1;bitfsv1b\x06proto3"
...
var file_v1_common_proto_goTypes = []any{
	(*LiveSegmentRef)(nil), // 0: bitfs.v1.LiveSegmentRef
}
