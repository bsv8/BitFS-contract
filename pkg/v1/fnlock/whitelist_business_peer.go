...
var whitelistBusinessPeer = []LockedFunction{
	...
	},
	{
		...
		Note:             "节点 route resolve 触发入口，只做查询，不是 setting 写入口。",
	},
	{
		ID:               "bitfs.clientapp.peer.trigger_self",
		Module:           ModuleBitFS,
		Package:          "./pkg/managedclient",
		Symbol:           "managedDaemon.executeManagedPeerSelfControlCommand",
		Signature:        "func (d *managedDaemon) executeManagedPeerSelfControlCommand(req controlCommandRequest) (controlCommandResult, error)",
	...
	},
	{
		...
		Module:           ModuleBitFS,
		Package:          "./pkg/managedclient",
		Symbol:           "managedDaemon.executeManagedPeerConnectControlCommand",
		Signature:        "func (d *managedDaemon) executeManagedPeerConnectControlCommand(req controlCommandRequest) (controlCommandResult, error)",
