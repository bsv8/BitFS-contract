...
const (
	// Label holds the string label denoting the procindexresolveroutes type in the database.
	Label = "proc_index_resolve_routes"
	...
	// Table holds the table name of the procindexresolveroutes in the database.
	Table = "proc_index_resolve_routes"
)

// Columns holds all SQL columns for procindexresolveroutes fields.
var Columns = []string{
	FieldID,
	FieldRoute,
	FieldSeedHash,
...
// OrderOption defines the ordering options for the ProcIndexResolveRoutes queries.
