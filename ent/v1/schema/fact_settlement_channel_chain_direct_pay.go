...
// FactSettlementChannelChainDirectPay 对齐表 fact_settlement_channel_chain_direct_pay。
type FactSettlementChannelChainDirectPay struct {
	ent.Schema
}

func (FactSettlementChannelChainDirectPay) Annotations() []schema.Annotation {
	return []schema.Annotation{entsql.Annotation{Table: "fact_settlement_channel_chain_direct_pay"}}
}

func (FactSettlementChannelChainDirectPay) Fields() []ent.Field {
	return []ent.Field{
...
func (FactSettlementChannelChainDirectPay) Edges() []ent.Edge {
	return []ent.Edge{
...
func (FactSettlementChannelChainDirectPay) Indexes() []ent.Index {
	return []ent.Index{
